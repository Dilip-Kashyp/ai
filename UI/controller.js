function js_function(types) {
eyes.express({ type: types });
...
class EyeController {
    constructor(elements = {}, eyeSize = '33.33vmin') {
      ...
      express({ type = '', duration = 3000, enterDuration = 75, exitDuration = 75 }) {
        if (!this._leftEye) {
    ...
    // Define the JavaScript function you want to call
